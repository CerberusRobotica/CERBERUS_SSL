...
#ifndef __cerberus_lcm_tartarus_hpp__
#define __cerberus_lcm_tartarus_hpp__

#include <lcm/lcm_coretypes.h>


namespace cerberus_lcm
{
...
int tartarus::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->teste, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int tartarus::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->teste, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
{
    uint64_t hash = 0x930c4b55f6cd10a4LL;
